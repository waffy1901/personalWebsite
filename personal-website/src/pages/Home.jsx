  ...
  return (
    <div className='min-h-screen flex flex-col font-["Cambria",_serif]'>
      <nav className='bg-blue-100 p-4'>
        <h1 className='text-3xl font-bold text-center text-gray-700'>Waffy Ahmed</h1>
        <p className='text-xl text-center text-gray-700'>Software Engineer | Georgia Tech</p>
      </nav>
