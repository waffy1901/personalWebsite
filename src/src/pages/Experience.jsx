  ...
  const workExperiences = [
    {
      ...
      bullets: [
        "Automated Spinnaker deployment pipelines for 10+ microservices with cdk8s, utilizing TypeScript, Terraform, and Google Cloud Platform for production and non-production environments, reducing deployment times by 20%.",
