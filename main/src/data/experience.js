...
export const workExperiences = [
  {
    id: "home-depot-software-engineer-ii",
  ...
  },
  {
    ...
    title: currentEmployment.roleHistory[1].title,
    company: currentEmployment.organization,
    location: currentEmployment.location,
    date: currentEmployment.roleHistory[1].date,
    timelinePreviewCount: 5,
    timelineExpandable: true,
    bullets: [
