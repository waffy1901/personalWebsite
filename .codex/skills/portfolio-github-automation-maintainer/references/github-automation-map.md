...
| --- | --- | --- | --- |
| Main PR CI | `.github/workflows/dev-ci.yml` | Runs install, lint, tests, and build for PRs to `main`. | Uses Node `22.22.0`, `npm ci`, and `main/package-lock.json` cache path. |
